...
#ifneq ($(filter walleye taimen blueline crosshatch bonito sargo flame coral redfin sunfish oriole raven, $(TARGET_PRODUCT_SHORT)),)
...
#endif
$(call inherit-product, vendor/evolution/bootanimation/bootanimation.mk)
